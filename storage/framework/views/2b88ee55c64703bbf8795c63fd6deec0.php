...
<body>
<nav>
    <a href="<?php echo e(route('pagrindinis')); ?>">Pagrindinis</a>
    <a href="<?php echo e(route('renginiai')); ?>">Auto renginiai</a>
    <a href="<?php echo e(route('mano_renginiai')); ?>">Mano renginiai</a>
    <a href="<?php echo e(route('xml')); ?>">XML</a>

    <div class="right">
        <a id="navPrisijungti" href="<?php echo e(route('prisijungti')); ?>">Prisijungti</a>
        <a id="navRegistruotis" href="<?php echo e(route('registruotis')); ?>">Registruotis</a>
        <a id="navProfilis" href="<?php echo e(route('profilis')); ?>" class="hide">Profilis</a>
...
</html><?php /**PATH C:\AUTOSKELB_praktika\auto-renginiai\resources\views/layouts/app.blade.php ENDPATH**/ ?>